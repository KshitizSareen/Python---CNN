...
def load_mnist():
    X_train = idx2numpy.convert_from_file('./src/MNIST_data/train-images.idx3-ubyte')
    train_labels = idx2numpy.convert_from_file('./src/MNIST_data/train-labels.idx1-ubyte')
    X_test = idx2numpy.convert_from_file('./src/MNIST_data/t10k-images.idx3-ubyte')
    test_labels = idx2numpy.convert_from_file('./src/MNIST_data/t10k-labels.idx1-ubyte')
